...
function generateNames(event) {
    ...
    let context = "You're an expert in every languages, with each prompt, you're going to give a list of baby names with their meaning and what language the names are in the following formate Name(pronunciantion,language):meaning.Give 20 names"
